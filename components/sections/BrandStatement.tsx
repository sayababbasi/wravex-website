        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div>
            ...
            <p className="text-lg text-gray-300 max-w-lg leading-relaxed">
              From intelligent automation to scalable digital products, Axiora Software combines modern technology with practical business thinking to create software that delivers measurable value.
            </p>
          </div>
